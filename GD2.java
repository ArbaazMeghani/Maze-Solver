...
public class GD2
{
    public static void main( String args[] )
   {
      ...
      for (int i = 3; i < 12; i++)
      {
        ...
        mySleep (250);  // sleep for 250 milliseconds i.e. 1/4 second
      }
      for (int i = 11; i > 3; i--)
      {
        disp.setColor (1, i, Color.LIGHT_GRAY);
        mySleep (500);  // sleep for 500 milliseconds i.e. 1/2 second
      }
      for (int i = 2; i < 12; i++)
      {
        disp.setColor (i, 3, Color.GREEN);
        mySleep (100);  // sleep for 100 milliseconds i.e. 1/10 second
      }
      for (int i = 2; i < 12; i++)
